...
class CreateController extends \October\Rain\Scaffold\Console\CreateController
{
    ...
    public function fire()
    {
        ...
        $vars['en']       = [
            ...
            $langPrefix . $plural . '.delete_confirm'          => 'Do you really want to delete this ' . $singular . '?',
            $langPrefix . $plural . '.delete_selected_success' => 'Successfully deleted the selected ' . $lowerTitlePlural . '.',
            $langPrefix . $plural . '.delete_selected_empty'   => 'There are no selected ' . $lowerTitlePlural . ' to delete.',
            $langPrefix . $plural . '.delete_selected_confirm' => 'Delete the selected ' . $lowerTitlePlural . '?',
